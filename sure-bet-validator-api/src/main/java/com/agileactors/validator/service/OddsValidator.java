...
public interface OddsValidator {
     ...
     *
     * @param oddsChange the odds data to validate
     ...
     */
    OddsValidationResponse validateOdds(OddsChange oddsChange) throws InterruptedException;

    /**
     * Broadcasts odds changes to connected clients.
     *
     * <p>Simulates pushing odds updates to websocket clients or message broker.
     * Intentionally slow (2 sec delay) to simulate broadcast latency.
     *
     * @param oddsChange the odds data to broadcast
     * @throws InterruptedException if broadcast is interrupted
     */
    void broadcastOddsChange(OddsChange oddsChange) throws InterruptedException;
}
